...
class AnalyticsViewDefault extends JView {
    ...
    function display($tpl = null) {
        ...
        $css = '.icon-48-chart-icon {background:url(../administrator/components/com_analytics/assets/images/chart-icon.png) no-repeat;}';
        $doc->addStyleDeclaration($css);
		
		$js ="Joomla.submitbutton = function(task) {
				location.href='index.php?option=com_analytics&task='+task;
			}";
